...
- ✅ Home-page listings browser — sort by newest / oldest / price (asc/desc) / most beds / most baths / best PK school. Filter chips for min beds (Any / 1+ / 2+ / 3+ / 4+), min baths (Any / 1+ / 2+ / 3+), max price (Any / <$2k / <$3k / <$4k / <$5k), and min PK-school rating (Any / 4+ / 7+ / 9+). Each listing's "best nearby PK school rating" is derived server-side by joining `listing_schools`, filtering to grade ranges starting with PK, and taking the max rating per listing.
